...
function validateForm() {
	  ...
	  var emailInput= document.getElementsByName('EmailValidation').value;
	  var userIDInput= document.getElementsByName('IdValidation').value;
	  var reasonInput= document.getElementsByName('reason').value;
